...
public class MessagingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    public static var cardData: [BusinessCard] = []
...
//        ])
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if MessagingViewController.cardData.isEmpty {
            let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath)
            cell.textLabel?.text = "Messaging coming soon, stay tuned!"
    ...
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if MessagingViewController.cardData.isEmpty {
            return 1
        } else {return MessagingViewController.cardData.count}
    }
